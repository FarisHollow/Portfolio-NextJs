...
const HeroSection = () => {
  return (
    <section id="home">
      <div className="flex flex-col text-center items-center justify-center animate-fadeIn animation-delay-2 my-0 py-0 sm:py-0 md:py-40 md:flex-row md:space-x-4 md:text-left">
        ...
        <div className="md:mt-2 md:w-3/5">
          ...
          <a
            ...
            className="text-neutral-100 font-semibold px-6 py-3 bg-teal-600 rounded shadow hover:bg-teal-700 ml-3" // Add appropriate styling
          >
            Download CV
          </a>
        </div>
